...
#Calculates the running average (non-blank) of the scores
def RunningAverage(self):
        ...
        if count == 0:
            ...
            return total / count
#Calculates the average of the scores, where missing scores are treated a zero
...
#Returns the letter grade based on TotalAverage
